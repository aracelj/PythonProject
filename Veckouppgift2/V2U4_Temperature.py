...
conversion_celsius_to_fahrenheit = 1.8 * input_celsius + 32
print("It will be", round(conversion_celsius_to_fahrenheit,1),"degrees Fahrenheit.")     # converts from celsius to fahrenheit
...
if input_temperature == 1:                                                          # converts from celsius to fahrenheit
      input_celsius = float(input("Enter temperature in degrees celsius: "))
      conversion_to_fahrenheit = 1.8 * input_celsius + 32
...
elif input_temperature == 2:                                                       # converts from fahrenheit to celsius
